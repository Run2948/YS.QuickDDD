...
namespace Quick.Repository
{
    ...
    public class BaseDal<T> : Disposable, IBaseDal<T> where T : class, new()
    {
        ...
        {
            return await Task.Run(() => WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where)).ConfigureAwait(true);
        }
        ...
        {
            return await Task.Run(() => isAsc ? WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).OrderBy(orderby) : WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).OrderByDescending(orderby)).ConfigureAwait(true);
        }
        ...
        public virtual async Task<IOrderedQueryable<T>> LoadEntitiesAsync<TS>(Expression<Func<T, bool>> @where, Expression<Func<T, TS>> @orderby, bool isAsc = true, params Expression<Func<T, TS>>[] thenby)
        {
            return await Task.Run(() =>
            {
                ...
                if (isAsc)
                {
                    query = WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).OrderBy(@orderby);
                    if (thenby.Length > 0)
                    {
                        foreach (var e in thenby)
                        {
                ...
                {
                    query = WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).OrderByDescending(@orderby);
                    if (thenby.Length > 0)
                    {
                        foreach (var e in thenby)
                        {
        ...
        {
            return await Task.Run(() => WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).ProjectToQueryable<TDto>()).ConfigureAwait(true);
        }
        ...
        {
            return await Task.Run(() => isAsc ? WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).OrderBy(orderby).ProjectToQueryable<TDto>() : WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).OrderByDescending(orderby).ProjectToQueryable<TDto>()).ConfigureAwait(true);
        }
        ...
        {
            return await WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).FromCacheAsync(CachePolicy.WithDurationExpiration(TimeSpan.FromSeconds(timespan))).ConfigureAwait(true);
        }
        ...
        {
            return await Task.Run(() => WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).Cacheable()).ConfigureAwait(true);
        }
        ...
        {
            return await Task.Run(() => isAsc ? WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).OrderBy(orderby).Cacheable() : WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).OrderByDescending(orderby).Cacheable()).ConfigureAwait(true);
        }
        ...
        {
            return await Task.Run(() => WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).ProjectToQueryable<TDto>().Cacheable()).ConfigureAwait(true);
        }
        ...
        {
            return await Task.Run(() => isAsc ? WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).OrderBy(orderby).ProjectToQueryable<TDto>().Cacheable() : WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).OrderByDescending(orderby).ProjectToQueryable<TDto>().Cacheable()).ConfigureAwait(true);
        }
        ...
        {
            return await Task.Run(() => WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).AsNoTracking()).ConfigureAwait(true);
        }
        ...
        {
            return await Task.Run(() => isAsc ? WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).OrderBy(orderby).AsNoTracking() : WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).OrderByDescending(orderby).AsNoTracking()).ConfigureAwait(true);
        }
        ...
        public virtual async Task<IQueryable<T>> LoadEntitiesNoTrackingAsync<TS>(Expression<Func<T, bool>> @where, Expression<Func<T, TS>> @orderby, bool isAsc = true, params Expression<Func<T, TS>>[] thenby)
        {
            return await Task.Run(() =>
            {
                ...
                if (isAsc)
                {
                    query = WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).AsNoTracking().OrderBy(@orderby);
                    if (thenby.Length > 0)
                    {
                        foreach (var e in thenby)
                        {
                ...
                {
                    query = WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).AsNoTracking().OrderByDescending(@orderby);
                    if (thenby.Length > 0)
                    {
                        foreach (var e in thenby)
                        {
        ...
        {
            return await Task.Run(() => WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).AsNoTracking().ProjectToQueryable<TDto>()).ConfigureAwait(true);
        }
        ...
        {
            return await Task.Run(() => isAsc ? WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).OrderBy(orderby).AsNoTracking().ProjectToQueryable<TDto>() : WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).OrderByDescending(orderby).AsNoTracking().ProjectToQueryable<TDto>()).ConfigureAwait(true);
        }
        ...
        {
            return await Task.Run(() => WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).AsNoTracking().Cacheable()).ConfigureAwait(true);
        }
        ...
        {
            return await Task.Run(() => isAsc ? WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).OrderBy(orderby).AsNoTracking().Cacheable() : WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).OrderByDescending(orderby).AsNoTracking().Cacheable()).ConfigureAwait(true);
        }
        ...
        {
            return await Task.Run(() => WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).AsNoTracking().ProjectToQueryable<TDto>().Cacheable()).ConfigureAwait(true);
        }
        ...
        {
            return await Task.Run(() => isAsc ? WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).OrderBy(orderby).AsNoTracking().ProjectToQueryable<TDto>().Cacheable() : WebExtension.GetDbContext<DefaultDbContext>().Set<T>().Where(@where).OrderByDescending(orderby).AsNoTracking().ProjectToQueryable<TDto>().Cacheable()).ConfigureAwait(true);
        }
        ...
        public virtual bool DeleteEntities(IEnumerable<T> list)
        {
            ...
            DataContext.Set<T>().RemoveRange(list);
            return true;
        }
        ...
        public virtual IEnumerable<T> AddEntities(IList<T> list)
        {
            ...
            DataContext.Set<T>().AddRange(list);
            return list;
        }
        ...
        {
            return parameters == null ? DataContext.Database.SqlQuery<TS>(sql) : DataContext.Database.SqlQuery<TS>(sql, parameters);
        }
        ...
        {
            return parameters == null ? DataContext.Database.SqlQuery(t, sql): DataContext.Database.SqlQuery(t, sql, parameters);
        }
        ...
        public virtual void ExecuteSql(string sql, params SqlParameter[] parameters)
        {
            if (parameters != null && parameters.Length > 0)
                ...
                DataContext.Database.ExecuteSqlCommand(TransactionalBehavior.EnsureTransaction, sql);
        }
        ...
        /// <returns></returns>
        public virtual DataTable ExecuteDataTable(string sql, params object[] parameters)
        {
            if (parameters != null && parameters.Length > 0)
                return DataContext.Database.SqlQueryForDataTable(sql, parameters);
            return DataContext.Database.SqlQueryForDataTable(sql);
        }
        ...
        /// <param name="parameters">要应用于 SQL 查询字符串的参数</param>
        /// <returns></returns>
        public virtual IEnumerable ExecuteDynamic(string sql, params object[] parameters)
        {
            if (parameters != null && parameters.Length > 0)
                return DataContext.Database.SqlQueryForDynamic(sql, parameters);
            return DataContext.Database.SqlQueryForDynamic(sql);
        }
